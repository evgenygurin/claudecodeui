...
5. **ui-drageasy-drag-and-drop-dashboard**
...
2. **v0-eleven-labs-music-starter**
...
8. **next-js-doc-like-file-tree-ui**
...
5. **ui-modern-library-design**
   ...
   - Описание: Поиск репозитория с названием "ui-modern-library-design"

6. **component-modern-library-design**
   - Query: `"component-modern-library-design" in:name`
   - Описание: Поиск репозитория с названием "component-modern-library-design"

7. **modern-library-design-component**
   - Query: `"modern-library-design-component" in:name`
   - Описание: Поиск репозитория с названием "modern-library-design-component"

8. **modern-library-design-ui**
   - Query: `"modern-library-design-ui" in:name`
   - Описание: Поиск репозитория с названием "modern-library-design-ui"

9. **modern-library-design-template**
   - Query: `"modern-library-design-template" in:name`
...
2. **v0-cuisine-selector-chips**
   - Query: `"v0-cuisine-selector-chips" in:name`
   - Описание: Поиск репозитория с названием "v0-cuisine-selector-chips"

3. **nextjs-cuisine-selector-chips**
   - Query: `"nextjs-cuisine-selector-chips" in:name`
   - Описание: Поиск репозитория с названием "nextjs-cuisine-selector-chips"

4. **react-cuisine-selector-chips**
   - Query: `"react-cuisine-selector-chips" in:name`
   - Описание: Поиск репозитория с названием "react-cuisine-selector-chips"

5. **ui-cuisine-selector-chips**
   - Query: `"ui-cuisine-selector-chips" in:name`
   - Описание: Поиск репозитория с названием "ui-cuisine-selector-chips"

6. **component-cuisine-selector-chips**
   - Query: `"component-cuisine-selector-chips" in:name`
   - Описание: Поиск репозитория с названием "component-cuisine-selector-chips"

7. **cuisine-selector-chips-component**
   - Query: `"cuisine-selector-chips-component" in:name`
   - Описание: Поиск репозитория с названием "cuisine-selector-chips-component"

8. **cuisine-selector-chips-ui**
   - Query: `"cuisine-selector-chips-ui" in:name`
   - Описание: Поиск репозитория с названием "cuisine-selector-chips-ui"

9. **cuisine-selector-chips-template**
   - Query: `"cuisine-selector-chips-template" in:name`
...
2. **v0-general-greeting**
   - Query: `"v0-general-greeting" in:name`
   - Описание: Поиск репозитория с названием "v0-general-greeting"

3. **nextjs-general-greeting**
   - Query: `"nextjs-general-greeting" in:name`
   - Описание: Поиск репозитория с названием "nextjs-general-greeting"

4. **react-general-greeting**
   - Query: `"react-general-greeting" in:name`
   - Описание: Поиск репозитория с названием "react-general-greeting"

5. **ui-general-greeting**
   - Query: `"ui-general-greeting" in:name`
   - Описание: Поиск репозитория с названием "ui-general-greeting"

6. **component-general-greeting**
   - Query: `"component-general-greeting" in:name`
   - Описание: Поиск репозитория с названием "component-general-greeting"

7. **general-greeting-component**
   - Query: `"general-greeting-component" in:name`
   - Описание: Поиск репозитория с названием "general-greeting-component"

8. **general-greeting-ui**
   - Query: `"general-greeting-ui" in:name`
   - Описание: Поиск репозитория с названием "general-greeting-ui"

9. **general-greeting-template**
   - Query: `"general-greeting-template" in:name`
...
2. **v0-marketplace**
   - Query: `"v0-marketplace" in:name`
   - Описание: Поиск репозитория с названием "v0-marketplace"

3. **nextjs-marketplace**
   - Query: `"nextjs-marketplace" in:name`
   - Описание: Поиск репозитория с названием "nextjs-marketplace"

4. **react-marketplace**
   - Query: `"react-marketplace" in:name`
   - Описание: Поиск репозитория с названием "react-marketplace"

5. **ui-marketplace**
   - Query: `"ui-marketplace" in:name`
   - Описание: Поиск репозитория с названием "ui-marketplace"

6. **component-marketplace**
   - Query: `"component-marketplace" in:name`
   - Описание: Поиск репозитория с названием "component-marketplace"

7. **marketplace-component**
   - Query: `"marketplace-component" in:name`
   - Описание: Поиск репозитория с названием "marketplace-component"

8. **marketplace-ui**
   - Query: `"marketplace-ui" in:name`
   - Описание: Поиск репозитория с названием "marketplace-ui"

9. **marketplace-template**
   - Query: `"marketplace-template" in:name`
...
2. **v0-background-paths**
   - Query: `"v0-background-paths" in:name`
   - Описание: Поиск репозитория с названием "v0-background-paths"

3. **nextjs-background-paths**
   - Query: `"nextjs-background-paths" in:name`
   - Описание: Поиск репозитория с названием "nextjs-background-paths"

4. **react-background-paths**
   - Query: `"react-background-paths" in:name`
   - Описание: Поиск репозитория с названием "react-background-paths"

5. **ui-background-paths**
   - Query: `"ui-background-paths" in:name`
   - Описание: Поиск репозитория с названием "ui-background-paths"

6. **component-background-paths**
   - Query: `"component-background-paths" in:name`
   - Описание: Поиск репозитория с названием "component-background-paths"

7. **background-paths-component**
   - Query: `"background-paths-component" in:name`
   - Описание: Поиск репозитория с названием "background-paths-component"

8. **background-paths-ui**
   - Query: `"background-paths-ui" in:name`
   - Описание: Поиск репозитория с названием "background-paths-ui"

9. **background-paths-template**
   - Query: `"background-paths-template" in:name`
...
2. **v0-creative**
   - Query: `"v0-creative" in:name`
   - Описание: Поиск репозитория с названием "v0-creative"

3. **nextjs-creative**
   - Query: `"nextjs-creative" in:name`
   - Описание: Поиск репозитория с названием "nextjs-creative"

4. **react-creative**
   - Query: `"react-creative" in:name`
   - Описание: Поиск репозитория с названием "react-creative"

5. **ui-creative**
   - Query: `"ui-creative" in:name`
   - Описание: Поиск репозитория с названием "ui-creative"

6. **component-creative**
   - Query: `"component-creative" in:name`
   - Описание: Поиск репозитория с названием "component-creative"

7. **creative-component**
   - Query: `"creative-component" in:name`
   - Описание: Поиск репозитория с названием "creative-component"

8. **creative-ui**
   - Query: `"creative-ui" in:name`
   - Описание: Поиск репозитория с названием "creative-ui"

9. **creative-template**
   - Query: `"creative-template" in:name`
...
2. **v0-shopify-product-page-design**
   - Query: `"v0-shopify-product-page-design" in:name`
   - Описание: Поиск репозитория с названием "v0-shopify-product-page-design"

3. **nextjs-shopify-product-page-design**
   - Query: `"nextjs-shopify-product-page-design" in:name`
   - Описание: Поиск репозитория с названием "nextjs-shopify-product-page-design"

4. **react-shopify-product-page-design**
   - Query: `"react-shopify-product-page-design" in:name`
   - Описание: Поиск репозитория с названием "react-shopify-product-page-design"

5. **ui-shopify-product-page-design**
   - Query: `"ui-shopify-product-page-design" in:name`
   - Описание: Поиск репозитория с названием "ui-shopify-product-page-design"

6. **component-shopify-product-page-design**
   - Query: `"component-shopify-product-page-design" in:name`
   - Описание: Поиск репозитория с названием "component-shopify-product-page-design"

7. **shopify-product-page-design-component**
   - Query: `"shopify-product-page-design-component" in:name`
   - Описание: Поиск репозитория с названием "shopify-product-page-design-component"

8. **shopify-product-page-design-ui**
   - Query: `"shopify-product-page-design-ui" in:name`
   - Описание: Поиск репозитория с названием "shopify-product-page-design-ui"

9. **shopify-product-page-design-template**
   - Query: `"shopify-product-page-design-template" in:name`
...
2. **v0-creative-agency-portfolio**
   - Query: `"v0-creative-agency-portfolio" in:name`
   - Описание: Поиск репозитория с названием "v0-creative-agency-portfolio"

3. **nextjs-creative-agency-portfolio**
   - Query: `"nextjs-creative-agency-portfolio" in:name`
   - Описание: Поиск репозитория с названием "nextjs-creative-agency-portfolio"

4. **react-creative-agency-portfolio**
   - Query: `"react-creative-agency-portfolio" in:name`
   - Описание: Поиск репозитория с названием "react-creative-agency-portfolio"

5. **ui-creative-agency-portfolio**
   - Query: `"ui-creative-agency-portfolio" in:name`
   - Описание: Поиск репозитория с названием "ui-creative-agency-portfolio"

6. **component-creative-agency-portfolio**
   - Query: `"component-creative-agency-portfolio" in:name`
   - Описание: Поиск репозитория с названием "component-creative-agency-portfolio"

7. **creative-agency-portfolio-component**
   - Query: `"creative-agency-portfolio-component" in:name`
   - Описание: Поиск репозитория с названием "creative-agency-portfolio-component"

8. **creative-agency-portfolio-ui**
   - Query: `"creative-agency-portfolio-ui" in:name`
   - Описание: Поиск репозитория с названием "creative-agency-portfolio-ui"

9. **creative-agency-portfolio-template**
   - Query: `"creative-agency-portfolio-template" in:name`
...
2. **v0-financial-dashboard-functional**
   - Query: `"v0-financial-dashboard-functional" in:name`
   - Описание: Поиск репозитория с названием "v0-financial-dashboard-functional"

3. **nextjs-financial-dashboard-functional**
   - Query: `"nextjs-financial-dashboard-functional" in:name`
   - Описание: Поиск репозитория с названием "nextjs-financial-dashboard-functional"

4. **react-financial-dashboard-functional**
   - Query: `"react-financial-dashboard-functional" in:name`
   - Описание: Поиск репозитория с названием "react-financial-dashboard-functional"

5. **ui-financial-dashboard-functional**
   - Query: `"ui-financial-dashboard-functional" in:name`
   - Описание: Поиск репозитория с названием "ui-financial-dashboard-functional"

6. **component-financial-dashboard-functional**
   - Query: `"component-financial-dashboard-functional" in:name`
   - Описание: Поиск репозитория с названием "component-financial-dashboard-functional"

7. **financial-dashboard-functional-component**
   - Query: `"financial-dashboard-functional-component" in:name`
   - Описание: Поиск репозитория с названием "financial-dashboard-functional-component"

8. **financial-dashboard-functional-ui**
   - Query: `"financial-dashboard-functional-ui" in:name`
   - Описание: Поиск репозитория с названием "financial-dashboard-functional-ui"

9. **financial-dashboard-functional-template**
   - Query: `"financial-dashboard-functional-template" in:name`
...
2. **v0-ai-elements-with-ai-sdk-5**
   - Query: `"v0-ai-elements-with-ai-sdk-5" in:name`
   - Описание: Поиск репозитория с названием "v0-ai-elements-with-ai-sdk-5"

3. **nextjs-ai-elements-with-ai-sdk-5**
   - Query: `"nextjs-ai-elements-with-ai-sdk-5" in:name`
   - Описание: Поиск репозитория с названием "nextjs-ai-elements-with-ai-sdk-5"

4. **react-ai-elements-with-ai-sdk-5**
   - Query: `"react-ai-elements-with-ai-sdk-5" in:name`
   - Описание: Поиск репозитория с названием "react-ai-elements-with-ai-sdk-5"

5. **ui-ai-elements-with-ai-sdk-5**
   - Query: `"ui-ai-elements-with-ai-sdk-5" in:name`
   - Описание: Поиск репозитория с названием "ui-ai-elements-with-ai-sdk-5"

6. **component-ai-elements-with-ai-sdk-5**
   - Query: `"component-ai-elements-with-ai-sdk-5" in:name`
   - Описание: Поиск репозитория с названием "component-ai-elements-with-ai-sdk-5"

7. **ai-elements-with-ai-sdk-5-component**
   - Query: `"ai-elements-with-ai-sdk-5-component" in:name`
   - Описание: Поиск репозитория с названием "ai-elements-with-ai-sdk-5-component"

8. **ai-elements-with-ai-sdk-5-ui**
   - Query: `"ai-elements-with-ai-sdk-5-ui" in:name`
   - Описание: Поиск репозитория с названием "ai-elements-with-ai-sdk-5-ui"

9. **ai-elements-with-ai-sdk-5-template**
   - Query: `"ai-elements-with-ai-sdk-5-template" in:name`
...
2. **v0-modern-ai-chatbot-interface-template**
   - Query: `"v0-modern-ai-chatbot-interface-template" in:name`
   - Описание: Поиск репозитория с названием "v0-modern-ai-chatbot-interface-template"

3. **nextjs-modern-ai-chatbot-interface-template**
   - Query: `"nextjs-modern-ai-chatbot-interface-template" in:name`
   - Описание: Поиск репозитория с названием "nextjs-modern-ai-chatbot-interface-template"

4. **react-modern-ai-chatbot-interface-template**
   - Query: `"react-modern-ai-chatbot-interface-template" in:name`
   - Описание: Поиск репозитория с названием "react-modern-ai-chatbot-interface-template"

5. **ui-modern-ai-chatbot-interface-template**
   - Query: `"ui-modern-ai-chatbot-interface-template" in:name`
   - Описание: Поиск репозитория с названием "ui-modern-ai-chatbot-interface-template"

6. **component-modern-ai-chatbot-interface-template**
   - Query: `"component-modern-ai-chatbot-interface-template" in:name`
   - Описание: Поиск репозитория с названием "component-modern-ai-chatbot-interface-template"

7. **modern-ai-chatbot-interface-template-component**
   - Query: `"modern-ai-chatbot-interface-template-component" in:name`
   - Описание: Поиск репозитория с названием "modern-ai-chatbot-interface-template-component"

8. **modern-ai-chatbot-interface-template-ui**
   - Query: `"modern-ai-chatbot-interface-template-ui" in:name`
   - Описание: Поиск репозитория с названием "modern-ai-chatbot-interface-template-ui"

9. **modern-ai-chatbot-interface-template-template**
   - Query: `"modern-ai-chatbot-interface-template-template" in:name`
...
2. **v0-origin-e-commerce-ui**
   - Query: `"v0-origin-e-commerce-ui" in:name`
   - Описание: Поиск репозитория с названием "v0-origin-e-commerce-ui"

3. **nextjs-origin-e-commerce-ui**
   - Query: `"nextjs-origin-e-commerce-ui" in:name`
   - Описание: Поиск репозитория с названием "nextjs-origin-e-commerce-ui"

4. **react-origin-e-commerce-ui**
   - Query: `"react-origin-e-commerce-ui" in:name`
   - Описание: Поиск репозитория с названием "react-origin-e-commerce-ui"

5. **ui-origin-e-commerce-ui**
   - Query: `"ui-origin-e-commerce-ui" in:name`
   - Описание: Поиск репозитория с названием "ui-origin-e-commerce-ui"

6. **component-origin-e-commerce-ui**
   - Query: `"component-origin-e-commerce-ui" in:name`
   - Описание: Поиск репозитория с названием "component-origin-e-commerce-ui"

7. **origin-e-commerce-ui-component**
   - Query: `"origin-e-commerce-ui-component" in:name`
   - Описание: Поиск репозитория с названием "origin-e-commerce-ui-component"

8. **origin-e-commerce-ui-ui**
   - Query: `"origin-e-commerce-ui-ui" in:name`
   - Описание: Поиск репозитория с названием "origin-e-commerce-ui-ui"

9. **origin-e-commerce-ui-template**
   - Query: `"origin-e-commerce-ui-template" in:name`
