...
/**
 * v0.app GitHub Link Auto Collector
 * 
 * Этот скрипт автоматически ищет GitHub ссылки для всех компонентов v0.app
 * 
 * Использование: node v0-github-auto-collector.js
 */
...
const components = [
  ...
  { name: "image-to-ascii-0UE1nczWzbu", url: "https://v0.app/community/image-to-ascii-0UE1nczWzbu", author: "rauchg", github: "https://github.com/rauchg/image-to-ascii" },
  ...
  { name: "chat-ui-with-vibration-xf3RmrkKlxc", url: "https://v0.app/community/chat-ui-with-vibration-xf3RmrkKlxc", author: "rauchg", github: "https://github.com/rauchg/chat-ui-with-vibration" },
  { name: "chat-ui-h4Ga3LeTpbl", url: "https://v0.app/community/chat-ui-h4Ga3LeTpbl", author: "issa-bourasse" },
  { name: "eleven-labs-conversational-ai-starter-5TN93pl3bRS", url: "https://v0.app/community/eleven-labs-conversational-ai-starter-5TN93pl3bRS", author: "elevenlabs-devs", github: "https://github.com/elevenlabs/agents-starter" },
...
console.log('🚀 v0.app GitHub Link Auto Collector');
console.log('====================================');
console.log(`📊 Всего компонентов: ${components.length}`);
console.log(`✅ Уже найдено: ${components.filter(c => c.github).length}`);
console.log('');

// Обработка каждого компонента
components.forEach((component, index) => {
  console.log(`📋 Компонент ${index + 1}/${components.length}: ${component.name}`);
  console.log(`🔗 URL: ${component.url}`);
  console.log(`👤 Автор: ${component.author}`);
  
  if (component.github) {
    console.log(`✅ GitHub: ${component.github}`);
    results.push({
      name: component.name,
      url: component.url,
...
const outputFile = 'v0-app-github-links-auto.md';
const markdown = `# v0.app Components - GitHub Repository Links (Auto Generated)
...
- **Найдено GitHub ссылок**: ${components.filter(c => c.github).length}
- **Не найдено**: ${components.filter(c => !c.github).length}

## Подтвержденные GitHub Репозитории

${components.filter(c => c.github).map(component => `
### ${component.name}
